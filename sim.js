(function()  {
    ...
    var radiusScale = d3.scaleSqrt().domain([3, 14]).range([10, 60])
    
    //Move all authors with 5-10 to the middle
    ...
    //Move all authors with 10+ to the middle
    ...
    //Move all authors with 1+ to the middle
    ...
    function ready (error, datapoints) {
        ...
        */
        ...
        //When button is click move back to the middle
